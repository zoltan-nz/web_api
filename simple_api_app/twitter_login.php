...
require (LIBRARY_PATH . '/tmhOAuth/tmhOAuth.php');
require (LIBRARY_PATH. '/tmhOAuth/tmhUtilities.php');
...
//Source: https://github.com/themattharris/tmhOAuthExamples/blob/master/web/oauth_authorize_flow.php
