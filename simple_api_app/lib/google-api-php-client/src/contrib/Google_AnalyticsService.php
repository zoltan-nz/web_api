...
class Google_AccountPermissions extends Google_Model
{
    ...
    public function setEffective( /* array(Google_string) */
        $effective)
    {
...
class Google_AnalyticsDataimportDeleteUploadDataRequest extends Google_Model
{
    ...
    public function setCustomDataImportUids( /* array(Google_string) */
...
class Google_Columns extends Google_Model
{
    ...
    public function setAttributeNames( /* array(Google_string) */
        $attributeNames)
    {
...
class Google_EntityUserLinkPermissions extends Google_Model
{
    ...
    public function setLocal( /* array(Google_string) */
        $local)
    {
...
class Google_EntityUserLinks extends Google_Model
{
    ...
    public function setItems( /* array(Google_EntityUserLink) */
        $items)
    {
...
class Google_Uploads extends Google_Model
{
    ...
    public function setItems( /* array(Google_Upload) */
        $items)
    {
